            ...
            <div className="row">
                <div className="col-lg-5 m-auto">
                    <div className="welcome-inner-header text-center">
                        ...
                        <a href="/">Home <span><i className="fa-light fa-angle-right"></i></span> Assault and Battery</a>
...
{/*===== SERVICES  STARTS =======*/}
<div className="service-left-inner-area sp1">
    <div className="container">
        <div className="row">
            <div className="col-lg-4">
                <div className="service-side-bararea">
                    ...
                    <div className="servicve-categories">
                        <h3>Our Services</h3>
                        <ul>
                    ...
                    <div className="download-brochure">
                        ...
                        <div className="download-btn">
                            <div className="pdf">
                                <a href="#"><img  src="/assets/img/icons/pdf.svg" alt="" />Pdf Download</a>
                            </div>
                            <div className="pdf">
                                <a href="#"><img  src="/assets/img/icons/pdf.svg" alt="" />Pdf Download</a>
                            </div>
            ...
            <div className="col-lg-8">
                <div className="service-rightbar-area">
                    <div className="service-img">
                        <img  src="/assets/img/images/service-left-img1.png" alt="" />
                    ...
                    <div className="service-left-text2">
                        ...
                        <div className="list">
                            <ul>
                                <li><a href="#"><img  src="/assets/img/icons/check-img5.svg" alt="" />Experienced Legal Guidance</a></li>
                                <li><a href="#"><img  src="/assets/img/icons/check-img5.svg" alt="" />Transparent Communication</a></li>
                            </ul>
                            <ul>
                                <li><a href="#"><img  src="/assets/img/icons/check-img5.svg" alt="" />Compassionate Support</a></li>
                                <li><a href="#"><img  src="/assets/img/icons/check-img5.svg" alt="" />Protecting Your Future</a></li>
                            </ul>
                            <ul>
                                <li><a href="#"><img  src="/assets/img/icons/check-img5.svg" alt="" />Legal Complexities</a></li>
                                <li><a href="#"><img  src="/assets/img/icons/check-img5.svg" alt="" />Success & Results</a></li>
                            </ul>
                        </div>
                    </div>
                    <div className="service-left-text3">
                        ...
                        <div className="row">
                            <div className="col-lg-6 col-mg-6">
                                <div className="service-left-img">
                                    <img  src="/assets/img/images/service-left-img2.png" alt="" />
                                </div>
                            </div>
                            <div className="col-lg-6 col-md-6">
                                <div className="service-left-img">
                                    <img  src="/assets/img/images/service-left-img3.png" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
...
{/*===== SERVICES STARTS =======*/}
<div className="service-left-sideinner sp3">
  <div className="container">
    <div className="row">
      <div className="col-lg-7 m-auto">
        <div className="service-left-header text-center">
          <h2>View More Our Related Service</h2>
        </div>
      </div>
    </div>
    <div className="row">
      <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="500" data-aos-easing="linear">
        <div className="service2-author-box">
            <div className="tax-icon-img">
                <img  src="/assets/img/icons/service-inner1.svg" alt="" />
            </div>
            ...
            <a href="/service-single" className="learn-more">Read More<i className="fa-regular fa-arrow-right"></i></a>
    ...
    <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="600" data-aos-easing="linear">
        <div className="service2-author-box">
            <div className="tax-icon-img">
                <img  src="/assets/img/icons/service-inner2.svg" alt="" />
            </div>
            <div className="tax-content">
    ...
    <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="800" data-aos-easing="linear">
        <div className="service2-author-box">
            <div className="tax-icon-img">
                <img  src="/assets/img/icons/service-inner3.svg" alt="" />
            </div>
            <div className="tax-content">
