...
{/*===== HEADER STARTS=======*/}
  <header className="header about-bg d-none d-lg-block">
    <div className="header-area header homepage1 header-sticky" id="header">
            ...
            <div className="header-elements">
              ...
              <div className="main-menu-ex homepage3">
                <ul>
                  ...
                  <li><a href="/about">About Us</a></li>
                   ...
                   <li><a href="#"> Practice Areas <span><i className="fa-solid fa-angle-down"></i></span></a>
                    <ul className="dropdown-padding">
                  ...
                  <li><a href="#" >Blogs <span><i className="fa-solid fa-angle-down"></i></span></a>
                    <ul className="dropdown-padding">
                  ...
                  <li><a href="#" >Pages <span><i className="fa-solid fa-angle-down"></i></span></a>
                    <ul className="dropdown-padding">
                  ...
                  <li><a href="#">Contact <span><i className="fa-solid fa-angle-down"></i></span></a>
                  <ul className="dropdown-padding">
              ...
              <div className="contact-3 d-lg-block d-none">
                <div className="consulting2">
                     ...
                     <a className="header__bar hamburger_menu header__bar-icon" href="javascript:void(0);">
                    ...
                    <div className="blog-left-images">
                        ...
                        <div className="blog-auhtor-area">
                            <div className="blog-auhtor-img1">
                                <a href="#"><img  src="/assets/img/images/blog-auhtor-img1.png" alt="" />Alex Robertson</a>
                            </div>
