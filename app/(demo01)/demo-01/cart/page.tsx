    ...
    {/*============ Breadcumb Start ============ */}
        <section className="breadcumb-wrapper text-center" data-bg-src="/demo-01/assets/img/breadcumb/breadcumb-bg.png">
                <div className=" wow img-custom-anim-scale" data-wow-duration="1.5s" data-wow-delay="0s">
                    <h2 className="breadcumb-title">Cart</h2>
                <p className="breadcumb-text"><a href="/demo-01/index-2">home </a> <i className="fa-regular fa-angles-right"></i>cart</p>
                </div>
        </section>
    {/*============ Breadcumb End============ */}
    {/*============ Cart Start ============ */}
    <div className="cart sec-pb-pt" >
        <div className="container">
            <table className="cart-table">
               <thead className="wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0s">
                  <tr>
                    <th className="d-none"></th>
                    <th className="cart-col-product">product</th>
                    <th className="cart-col-description">description</th>
             ...
             <tbody>
                <tr className="cart-item wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0s">
                    <td data-title="product">
                        <a href="/demo-01/cart" className="cart-item-close"><i className="fa-solid fa-xmark"></i></a>
                        <a href="/demo-01/cart" className="cart-product-image">
                            <img  src="/demo-01/assets/img/products/product-1.png" alt="" />
                        </a>
                    </td>
                    <td data-title="description">
                        <a href="/demo-01/cart" className="cart-product-name">
                            Lincoin Project Book <br  /> Emancipation
                        </a>
                    </td>
                    <td data-title="price">
                        <span className="cart-product-price">$120.85</span>
                       
                    </td>
                    <td data-title="quantity">
                        <div className="quantity-wrapper">
                            <input  className="quantity-value" type="text"
                              name="quantity" id="inpit1"  value="1" title="Qty" />
                            <button className="quantity-plus"><i className="fa-solid fa-plus"></i>
                            </button>
                            <button className="quantity-minus"><i className="fa-solid fa-minus"></i></button>
                        </div>
                    </td>
                    <td data-title="total">
                        <span className="cart-product-total">$120.85</span>
                    </td>
                    <td data-title="remove">
                        <span className="cart-product-total">
                            <a href="/demo-01/cart" className="cart-item-close xmark"><i className="fa-solid fa-xmark"></i></a>
                        </span>
                    </td>
                </tr>
                ...
                <tr className="cart-item wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0s">
                    ...
                    <td data-title="description">
                        <a href="/demo-01/cart" className="cart-product-name">
                            Deciphering Contracts <br  />Fine Print
                        </a>
                    </td>
                    <td data-title="price">
                        <span className="cart-product-price">$100.63</span>
                       
                    </td>
                    <td data-title="quantity">
                        <div className="quantity-wrapper">
                            <input  className="quantity-value" type="text"
                             name="quantity" id="input2"   value="1" title="Qty" />
                            <button className="quantity-plus"><i className="fa-solid fa-plus"></i></button>
                            <button className="quantity-minus"><i className="fa-solid fa-minus"></i></button>
                        </div>
                    </td>
                    <td data-title="total">
                        <span className="cart-product-total">$100.63</span>
                    </td>
                     <td data-title="remove">
                        <span className="cart-product-total">
                            <a href="/demo-01/cart" className="cart-item-close xmark"><i className="fa-solid fa-xmark"></i></a>
                ...
                <tr className="cart-item wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0s">
                    ...
                    <td data-title="description">
                        <a href="/demo-01/cart" className="cart-product-name">
                            Unlocking Legal <br  />Loopholes
                        </a>
                    </td>
                    <td data-title="price">
                        <span className="cart-product-price">$104.46</span>
                       
                    </td>
                    <td data-title="quantity">
                       <div className="quantity-wrapper">
                            <input  className="quantity-value" 
                             name="quantity" id="input3"  value="1" title="Qty" />
                            <button className="quantity-plus"><i className="fa-solid fa-plus"></i></button>
                            <button className="quantity-minus"><i className="fa-solid fa-minus"></i></button>
                        </div>
                    </td>
                    <td data-title="total">
                        <span className="cart-product-total">$104.46</span>
                    </td>
                     <td data-title="remove">
                        <span className="cart-product-total">
                            <a href="/demo-01/cart" className="cart-item-close xmark"><i className="fa-solid fa-xmark"></i></a>
            ...
            <div className="cart-item cart-btn-wrap flex justify-between md-block wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0s">
                   <div className="coupon-wrap">
                    <a href="/demo-01/cart" className="promo-code main-btn two">promo code here</a>
                    <a href="/demo-01/cart" className="apply-coupon main-btn">apply coupon</a>
                   </div>
                   <a href="/demo-01/cart" className="update-cart main-btn">update cart</a>
            </div>
           <div className="cart-tools wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0s">
            <h3 className="cart-tools-title">cart tools</h3>
            <p><span>Subtotal:</span> <span>$362</span></p>
            <span className="shipping">Shipping</span>
            <div className="cart-tools-item flex">
                <p><i className="checkout-checkbox1 checkout-checkbox1-active"></i>Free Shipping</p>
                <span className="price">+$00.00</span>
            </div>
            <div className="cart-tools-item flex">
                <p><i className="checkout-checkbox2"> </i>Flat Rate</p>
                <span className="price">+$20.00</span>
            </div>
            <div className="cart-tools-item flex">
                <p><i className="checkout-checkbox3"></i>Local Delivery</p>
                <span className="price">+$15.00</span>
            </div>
            <p><span className="shipping total">total:</span> <span className="highlight">$377</span></p>
           <a href="/demo-01/checkout" className="main-btn">proceed to check out</a>
           </div>
