 ...
 {/*============ Breadcumb Start ============ */}
    <section className="breadcumb-wrapper text-center" data-bg-src="/demo-01/assets/img/breadcumb/breadcumb-bg.png">
            <div className="wow img-custom-anim-scale" data-wow-duration="1.5s" data-wow-delay="0s">
                <h2 className="breadcumb-title">error 404</h2>
            <p className="breadcumb-text"><a href="/demo-01/index-2">home </a> <i className="fa-regular fa-angles-right"></i>error 404</p>
            </div>
    </section>
{/*============ Breadcumb End============ */}
{/*============ Error 404 Start ============ */}
   <div className="error sec-pb-pt">
    <div className="container">
        <div className="error-wrapper text-center wow img-custom-anim-scale" data-wow-duration="1.5s" data-wow-delay="0.6s">
            <div className="error-thumb">
                <img  src="/demo-01/assets/img/error/404.png" alt="" />
            </div>
            <div className="error-text">
                <h2>Ooops Page Not Found</h2>
                <p>It looks like nothing was found at this location. Maybe try one of the <br  />
                links below or a search?</p>
                <a href="/demo-01/index-2" className="main-btn">
                    Back to Home <i className="fa-solid fa-location-arrow"></i> 
                </a>
            </div>
        </div>
    </div>
