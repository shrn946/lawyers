  ...
  return (
            ...
            <div className="accordion" id="accordionPanelsStayOpenExample">
                <div className="mobile-menu-accordion-item">
                    <h2 className="mobile-menu-accordion-header">
                        ...
                        <button className="mobile-menu-accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <div id="panelsStayOpen-collapseThree" className="accordion-collapse collapse">
                        <div className="mobile-menu-accordion-body">
                            <ul>
                                ...
                                <li><a href="/demo-01/practice-details"><i className="fa-solid fa-angle-right"></i>practice
                                        details</a></li>
                                <li><a href="/demo-01/attorney"><i className="fa-solid fa-angle-right"></i>attorney</a></li>
                                <li><a href="/demo-01/attorney-details"><i className="fa-solid fa-angle-right"></i>attorney
                                        details </a></li>
                                ...
                                <li><a href="/demo-01/product-details"><i className="fa-solid fa-angle-right"></i>product
                                        details</a></li>
                    ...
                    <div id="panelsStayOpen-collapseFour" className="accordion-collapse collapse">
                        <div className="mobile-menu-accordion-body">
                            <ul>
                                ...
                                <li><a href="/demo-01/case-details"><i className="fa-solid fa-angle-right"></i>case-details</a>
                                </li>
                    ...
                    <div id="panelsStayOpen-collapseFive" className="accordion-collapse collapse">
                        <div className="mobile-menu-accordion-body">
                            <ul>
                                ...
                                <li><a href="/demo-01/blog-standard"><i className="fa-solid fa-angle-right"></i>blog
                                        standard</a></li>
                                <li><a href="/demo-01/blog-details"><i className="fa-solid fa-angle-right"></i>blog details</a>
                                </li>
                    ...
                    <div className="row">
                        ...
                        <div className=" col-xl-7 col-lg-7 md-none">
                            <div className="header-menu  two">
                                <nav>
                                    <ul>
                                        <li className="sub-menu"><a href="/demo-01/index-2">home <i
                                                    className="fa-solid fa-plus plus"></i><i
                                                    className="fa-solid fa-minus minus"></i>
                                            </a>
                                            <ul className="dropdown-menu">
                                                <li><a href="/demo-01/index-2"><i className="fa-solid fa-angle-right"></i>Home
                                                        01</a></li>
                                                <li><a href="/demo-01/index-3"><i className="fa-solid fa-angle-right"></i>Home
                                                        02</a></li>
                                                <li><a href="/demo-01/index-4"><i className="fa-solid fa-angle-right"></i>Home
                                                        03</a></li>
                                                <li><a href="/demo-01/index-5"><i className="fa-solid fa-angle-right"></i>Home
                                                        04</a></li>
                                            </ul>
                                        </li>
                                        <li className="sub-menu  "><a href="/demo-01/about">about us
                                                <i className="fa-solid fa-plus plus"></i><i
                                                    className="fa-solid fa-minus minus"></i>
                                            </a>
                                            <ul className="dropdown-menu">
                                                
                                                <li><a href="/demo-01/about"><i className="fa-solid fa-angle-right"></i>about
                                                        us</a></li>
                                            </ul>
                                        </li>
                                        <li className="sub-menu mega-menu-wrapper"><a href="#">pages
                                            ...
                                            <ul className=" dropdown-menu mega-menu two flex justify-between">
                                                <li>
                                                    ...
                                                    <ul>
                                                        <li><a href="/demo-01/index-2"><i
                                                                    className="fa-solid fa-angle-right"></i>home 01</a></li>
                                                        <li><a href="/demo-01/index-3"><i
                                                                    className="fa-solid fa-angle-right"></i>home 02</a></li>
                                                        <li><a href="/demo-01/index-4"><i
                                                                    className="fa-solid fa-angle-right"></i>home 03</a></li>
                                                        <li><a href="/demo-01/index-5"><i
                                                                    className="fa-solid fa-angle-right"></i>home 04</a></li>
                                                        <li><a href="/demo-01/about"><i
                                                                    className="fa-solid fa-angle-right"></i>about us</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li>
                                                    ...
                                                    <ul>
                                                        <li><a href="/demo-01/practice"><i
                                                                    className="fa-solid fa-angle-right"></i>practice</a>
                                                        </li>
                                                        <li><a href="/demo-01/practice-details"><i
                                                                    className="fa-solid fa-angle-right"></i>practice
                                                                details</a></li>
                                                        <li><a href="/demo-01/case"><i
                                                                    className="fa-solid fa-angle-right"></i>case</a></li>
                                                        <li><a href="/demo-01/case-details"><i
                                                                    className="fa-solid fa-angle-right"></i>case details</a>
                                                        </li>
                                                        <li><a href="/demo-01/attorney"><i
                                                                    className="fa-solid fa-angle-right"></i>attorney</a>
                                                        </li>
                                                        <li><a href="/demo-01/attorney-details"><i
                                                                    className="fa-solid fa-angle-right"></i>attorney
                                                                details</a></li>
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        <li><a href="/demo-01/price"><i
                                                                    className="fa-solid fa-angle-right"></i>price</a></li>
                                                        <li><a href="/demo-01/faq"><i
                                                                    className="fa-solid fa-angle-right"></i>FAQ</a></li>
                                                        <li><a href="/demo-01/product"><i
                                                                    className="fa-solid fa-angle-right"></i>product</a></li>
                                                        <li><a href="/demo-01/product-details"><i
                                                                    className="fa-solid fa-angle-right"></i>product
                                                                details</a></li>
                                                        <li><a href="/demo-01/cart"><i
                                                                    className="fa-solid fa-angle-right"></i>Cart</a></li>
                                                        <li><a href="/demo-01/checkout"><i
                                                                    className="fa-solid fa-angle-right"></i>checkout</a>
                                                        </li>
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        <li><a href="/demo-01/blog"><i
                                                                    className="fa-solid fa-angle-right"></i>blog</a></li>
                                                        <li><a href="/demo-01/blog-standard"><i
                                                                    className="fa-solid fa-angle-right"></i>blog
                                                                standard</a></li>
                                                        <li><a href="/demo-01/blog-details"><i
                                                                    className="fa-solid fa-angle-right"></i>blog details</a>
                                                        </li>
                                                        <li><a href="/demo-01/contact"><i
                                                                    className="fa-solid fa-angle-right"></i>contact</a></li>
                                                        <li><a href="/demo-01/error"><i
                                                                    className="fa-solid fa-angle-right"></i>error 404</a>
                                                        </li>
                                        ...
                                        <li className="sub-menu"><a href="/demo-01/case">case studies
                                            ...
                                            <ul className="dropdown-menu">
                                                <li><a href="/demo-01/case"><i
                                                            className="fa-solid fa-angle-right"></i>case-studies</a></li>
                                                <li><a href="/demo-01/case-details"><i
                                                            className="fa-solid fa-angle-right"></i>case details</a></li>
                                            </ul>
                                        </li>
                                        <li className="sub-menu"><a href="/demo-01/blog">blog
                                            ...
                                            <ul className="dropdown-menu">
                                                <li><a href="/demo-01/blog"><i className="fa-solid fa-angle-right"></i>blog</a>
                                                </li>
                                                <li><a href="/demo-01/blog-standard"><i
                                                            className="fa-solid fa-angle-right"></i>blog standard</a></li>
                                                <li><a href="/demo-01/blog-details"><i
                                                            className="fa-solid fa-angle-right"></i>blog details</a></li>
                                            </ul>
                                        </li>
                        ...
                        <div className="col-lg-3 col-6">
                            <div className="header-button three text-right ">
                                ...
                                <a href="/demo-01/contact" className="main-btn md-none">contact us<svg width="16" height="11"
    ...
    <main>
        ...
        <section className="service sec-pb-pt">
            <div className="container">
                <div className="sec-title text-center mb-60 wow img-custom-anim-scale" data-wow-duration="1.5s"
                    data-wow-delay="0.1s">
                    <span className="sub-title two"> What do you Offer</span>
                    <h2>Services You Can Trust</h2>
                </div>
                <div className="row gx-lg-3 gx-xl-4 service-3">
                    <div className="col-lg-3 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.1s">
                    ...
                    <div className="col-lg-3 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
                        <div className="service-content service-content-3">
                            <div className="service-text service-text-3 text-center">
                                <div className="icon-area">
                                    <div className="icon">
                    ...
                    <div className="col-lg-3 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.7s">
                        <div className="service-content service-content-3">
                            <div className="service-text service-text-3 text-center">
                                <div className="icon-area">
                                    <div className="icon">
                    ...
                    <div className="col-lg-3 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="1.1s">
                        <div className="service-content service-content-3">
                            <div className="service-text service-text-3 text-center">
                                <div className="icon-area">
                                    <div className="icon">
        ...
        {/*============ Service End ============ */}
        {/*============ Banner Start ============ */}
        <div className="banner three  sec-pb">
            <div className="container">
        ...
        <section className="about three sec-pb-pt p-relative">
            <div className="container">
                <div className="row">
                    <div className="col-lg-6 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.1s">
                        {/* <div className="about-thumb three cover">
                            <img  src="/demo-01/assets/img/about/about3-thumb.png" alt="" />
                        </div> */}
                        <div className="about-thumb three p-relative">
                            <img  src="/demo-01/assets/img/about/about3-img.png" alt="" />
                            <div className="img2 cover">
                            <img   src="/demo-01/assets/img/about/about3-img2.png" alt="" />
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-6 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.5s">
                        <div className="about-content three">
                            <div className=" about-title sec-title">
                                ...
                                <p className="gray">If you're unsure, we offer consultations to help determine any whether
                                    legal representation is necessary to resolve matters efficiently while prioritizing
                                    best interests.</p>
                            </div>
                            ...
                            <div className="about-tabs mt-40">
                                <nav>
                                    <div className="nav about-nav-tabs" id="nav-tab" role="tablist">
                                        <button className="about-nav-link " id="nav-home-tab" data-bs-toggle="tab"
                                            data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home"
                                            aria-selected="true">Our Mission</button>
                                        <button className="about-nav-link active" id="nav-profile-tab" data-bs-toggle="tab"
                                            data-bs-target="#nav-profile" type="button" role="tab"
                                            aria-controls="nav-profile" aria-selected="false">Our Strategy</button>
                                        <button className="about-nav-link" id="nav-contact-tab" data-bs-toggle="tab"
                                            data-bs-target="#nav-contact" type="button" role="tab"
                                            aria-controls="nav-contact" aria-selected="false">Our Vision</button>

                                    </div>
                                </nav>
                                <div className="about-tab-content mt-40" id="nav-tabContent">
                                    <div className="about-tab-pane tab-pane fade " id="nav-home" role="tabpanel"
                                        aria-labelledby="nav-home-tab" tabIndex="0">
                                        <ul>
                                            <li><i className="fa-regular fa-check-circle"></i>Estate planning and trust
                                                creation</li>
                                            <li><i className="fa-regular fa-check-circle"></i>Mediation and conflict
                                                resolution</li>
                                            <li><i className="fa-regular fa-check-circle"></i>Personal injury claims
                                                assistance</li>
                                            <li><i className="fa-regular fa-check-circle"></i>Family law and custody
                                                services</li>
                                        </ul>
                                        <div className="about-thumb2 three cover fix p-relative">
                                            ...
                                            <div className="play-btn-area p-absolute">
                                                <a href="https://www.youtube.com/watch?v=zYRgrWtzpc0"
                                                    className="video-play popup-video"><i className="fa-solid fa-play"></i>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="about-tab-pane fade show active" id="nav-profile" role="tabpanel"
                                    ...
                                    <div className="about-tab-pane fade" id="nav-contact" role="tabpanel"
                            ...
                            <div className="about-btn-area d-flex mt-40">
                                <a href="/demo-01/about" className="main-btn mr-20">more about<svg width="16" height="11"
                                        viewBox="0 0 16 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M14.4375 6.37085C14.6861 6.37085 14.9246 6.27208 15.1004 6.09626C15.2762 5.92045 15.375 5.68199 15.375 5.43335C15.375 5.18471 15.2762 4.94625 15.1004 4.77044C14.9246 4.59462 14.6861 4.49585 14.4375 4.49585H0.937499C0.688858 4.49585 0.450401 4.59462 0.274586 4.77044C0.0987701 4.94625 -9.53674e-07 5.18471 -9.53674e-07 5.43335C-9.53674e-07 5.68199 0.0987701 5.92045 0.274586 6.09626C0.450401 6.27208 0.688858 6.37085 0.937499 6.37085H14.4375Z"
                                            fill="white" />
            ...
            <div className="about-vector1">
                <img  src="/demo-01/assets/img/about/vector-1.png" alt="" />
            </div>
        </section>
        {/*============ About End ============ */}
        {/*============ Contact Start ============ */}
        <section className="contact-3 " data-bg-src="/demo-01/assets/img/contact/contact-bg-2.png">
            <div className="container">
                <div className="counter-2 three wow" data-wow-duration="1.5s" data-wow-delay="0s"
                    data-bg-src="/demo-01/assets/img/contact/counter-bg-1.png">
                ...
                <div className="contact-3-wrapper p-relative">
                    <div className=" contact-title sec-title ">
                        ...
                        <a href="/demo-01/contact" className="main-btn mt-40">explore More <svg width="16" height="11"
                                viewBox="0 0 16 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M14.4375 6.37085C14.6861 6.37085 14.9246 6.27208 15.1004 6.09626C15.2762 5.92045 15.375 5.68199 15.375 5.43335C15.375 5.18471 15.2762 4.94625 15.1004 4.77044C14.9246 4.59462 14.6861 4.49585 14.4375 4.49585H0.937499C0.688858 4.49585 0.450401 4.59462 0.274586 4.77044C0.0987701 4.94625 -9.53674e-07 5.18471 -9.53674e-07 5.43335C-9.53674e-07 5.68199 0.0987701 5.92045 0.274586 6.09626C0.450401 6.27208 0.688858 6.37085 0.937499 6.37085H14.4375Z"
                                    fill="white" />
                        ...
                        <a href="/demo-01/contact" className="main-btn two">contact us <svg width="16" height="11"
                                viewBox="0 0 16 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M14.4375 6.37085C14.6861 6.37085 14.9246 6.27208 15.1004 6.09626C15.2762 5.92045 15.375 5.68199 15.375 5.43335C15.375 5.18471 15.2762 4.94625 15.1004 4.77044C14.9246 4.59462 14.6861 4.49585 14.4375 4.49585H0.937499C0.688858 4.49585 0.450401 4.59462 0.274586 4.77044C0.0987701 4.94625 -9.53674e-07 5.18471 -9.53674e-07 5.43335C-9.53674e-07 5.68199 0.0987701 5.92045 0.274586 6.09626C0.450401 6.27208 0.688858 6.37085 0.937499 6.37085H14.4375Z"
                                    fill="white" />
                    ...
                    <div className="play-btn-area p-absolute">
                        <a href="https://www.youtube.com/watch?v=zYRgrWtzpc0" className="video-play popup-video"><i
        ...
        <section className="expart sec-pb-pt p-relative">
            ...
            <div className="expart-vector1 p-absolute">
                <img  src="/demo-01/assets/img/expart/vector-1.png" alt="" />
            </div>
        </section>
        {/*============ Expart End ============ */}

        {/*============ FAQ Start ============ */}
        <section className="faq sec-pb-pt-120">
            <div className="container">
                <div className="row">
                    <div className="col-lg-6 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0s">
                            ...
                            <div className="faq-accordion" id="accordionExample">
                                <div className="faq-accordion-item">
                                    <h2 className="faq-accordion-header" id="headingOne">
                                        <button className="faq-accordion-button" type="button" data-bs-toggle="collapse"
                                    ...
                                    <div id="collapseOne" className="accordion-collapse collapse show"
                                        ...
                                        <div className="faq-accordion-body">
                                            <span>The timeline depends on the complexity and nature of the case. We aim
                                                a to resolve matters efficiently while prioritizing your best interests
                                                legal an issue or making a significant decision, consulting a lawyer
                                                ensures you is understand your rights and options.</span>
                                ...
                                <div className="faq-accordion-item">
                                    <h2 className="faq-accordion-header" id="headingTwo">
                                        <button className="faq-accordion-button collapsed" type="button"
                            ...
                            <div className="blog-content">
                                ...
                                <div className="blog-content-text">
                                    <div className="date-admin">
                                        <a href="/demo-01/blog-details"><i className="fa-solid fa-calendar-days"></i>10 April,
                                            2024</a>
                                        <a href="/demo-01/blog-details"><i className="fa-solid fa-user"></i>Admin</a>
                                    </div>
                                    <a href="/demo-01/blog-details" className="blog-content-title">Turning Legal Challenges into
                                        Opportunities</a>
                                    <a href="/demo-01/blog-details" className="blog-btn"><span className="angels"><img 
                                                src="/demo-01/assets/img/icon/double-angle.svg" alt="" /></span> read more</a>
                                    ...
                                    <div className="share-area">
                                        <div className="share share-icon1">
                                            ...
                                            <div className="social-wrapper  social-wrapper-toggle1">
                                                ...
                                                <a href="https://www.behance.com/"><i
                                                        className="fa-brands fa-behance"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="col-lg-4 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.8s">
                        <div className="blog-content">
                            ...
                            <div className="blog-content-text">
                                ...
                                <a href="/demo-01/blog-details" className="blog-content-title">Timelines vary based on free
                                    complexity of the case</a>
                                <a href="/demo-01/blog-details" className="blog-btn"><span className="angels"><img 
                                            src="/demo-01/assets/img/icon/double-angle.svg" alt="" /></span> read more</a>
                    ...
                    <div className="col-lg-4 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="1.2s">
                        <div className="blog-content">
                            ...
                            <div className="blog-content-text">
                                ...
                                <a href="/demo-01/blog-details" className="blog-content-title">We focus on achieving based
                                    amicable solutions </a>
                                <a href="/demo-01/blog-details" className="blog-btn"><span className="angels"><img 
                                            src="/demo-01/assets/img/icon/double-angle.svg" alt="" /></span> read more</a>
                ...
                <div className="container">
                    ...
                    <div className="footer-middle-wrapper">
                        {/* <div className=" footer-item footer-service">
                            <h3>our services</h3>
                            <ul>
                                <li><a href="/demo-01/about"><i className="fa-regular fa-angle-right"></i>Business Formation</a>
                                </li>
                                ...
                                <li><a href="/demo-01/about"><i className="fa-regular fa-angle-right"></i>Intellectual Property
                                        Law</a></li>
                                <li><a href="/demo-01/about"><i className="fa-regular fa-angle-right"></i>Real Estate Law</a>
                                </li>
                        ...
                        <div className=" footer-item footer-pages">
                            ...
                            <ul>
                                ...
                                <li><a href="/demo-01/contact"><i className="fa-regular fa-angle-right"></i>Get In Touch</a>
                                </li>
                ...
                <div className="container">
                    <div className="footer-bottom-wrapper">
                        <div className="footer-bottom-left">
                            <p>Copyright © 2026 <a className="highlight" href="/demo-01/index-2">Lawia</a>. All rights reserved By
                                <a href="/demo-01/index-2" className="highlight">Vecuro</a>. </p>
                        </div>
