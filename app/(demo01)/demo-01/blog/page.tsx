 ...
 {/*============ Breadcumb Start ============ */}
    <section className="breadcumb-wrapper text-center" data-bg-src="/demo-01/assets/img/breadcumb/breadcumb-bg.png">
           <div className="wow img-custom-anim-scale" data-wow-duration="1.5s" data-wow-delay="0s">
             <h2 className="breadcumb-title">Blog</h2>
            <p className="breadcumb-text"><a href="/demo-01/index-2">home </a> <i className="fa-regular fa-angles-right"></i>Blog </p>
           </div>
    </section>
 {/*============ Breadcumb End ============ */}
 {/*============ Blog Start ============ */}
    <section className="blog sec-pb-pt-120" >
        <h2 className="d-none">latest blog post</h2>
        <div className="container">
            <div className="row gx-0 gx-md-4 gy-4 ">
                <div className="col-xl-4 col-md-6 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
                    <div className="blog-content blog-content-inner">
                        ...
                        <div className="blog-content-text">
                            <div className="date-admin">
                                <a href="/demo-01/blog-details"><i className="fa-solid fa-calendar-days"></i>10 March, 2026</a>
                ...
                <div className="col-xl-4 col-md-6 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.8s">
                    <div className="blog-content blog-content-inner">
                        <div className="blog-thumb mega-hover fix cover">
                ...
                <div className="col-xl-4 col-md-6 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="1.2s">
                    <div className="blog-content blog-content-inner">
                        <div className="blog-thumb mega-hover fix cover">
                ...
                <div className="col-xl-4 col-md-6 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0s">
                    <div className="blog-content blog-content-inner">
                        <div className="blog-thumb mega-hover fix cover">
                            <img  src="/demo-01/assets/img/blog/blog-4.jpg" alt="" />
                        </div>
                        <div className="blog-content-text">
                            <div className="date-admin">
                                <a href="/demo-01/blog-details"><i className="fa-solid fa-calendar-days"></i>10 March, 2026</a>
                            ...
                            <a href="/demo-01/blog-details" className="blog-content-title">Defending Your Right Protecting Your Future</a>
                            <a href="/demo-01/blog-details" className="blog-btn"><span className="angels"><img  src="/demo-01/assets/img/icon/double-angle.svg" alt="" /></span> read more</a>

                            <div className="share-area">
                                <div className="share share-icon4">
                                    <i className="fa-solid fa-share-nodes"></i>
                                    <div className="social-wrapper  social-wrapper-toggle4">
                                  <a href="https://www.facebook.com/"><i className="fa-brands fa-facebook-f"></i></a>
                                    <a href="https://www.x.com/"><i className="fa-brands fa-twitter"></i></a>
                                    <a href="https://www.instagram.com/"><i className="fa-brands fa-instagram"></i></a>
                                    <a href="https://www.behance.com/"><i className="fa-brands fa-behance"></i></a>
                ...
                <div className="col-xl-4 col-md-6 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
                    <div className="blog-content blog-content-inner">
                        <div className="blog-thumb mega-hover fix cover">
                            <img  src="/demo-01/assets/img/blog/blog-5.png" alt="" />
                        </div>
                        <div className="blog-content-text">
                            <div className="date-admin">
                                <a href="/demo-01/blog-details"><i className="fa-solid fa-calendar-days"></i>10 March, 2026</a>
                            ...
                            <a href="/demo-01/blog-details" className="blog-content-title">Timelines vary based on the type of case but we aim</a>
                            <a href="/demo-01/blog-details" className="blog-btn"><span className="angels"><img  src="/demo-01/assets/img/icon/double-angle.svg" alt="" /></span> read more</a>

                            <div className="share-area">
                                <div className="share share-icon5">
                                    <i className="fa-solid fa-share-nodes"></i>
                                    <div className="social-wrapper  social-wrapper-toggle5">
                                  <a href="https://www.facebook.com/"><i className="fa-brands fa-facebook-f"></i></a>
                                    <a href="https://www.x.com/"><i className="fa-brands fa-twitter"></i></a>
                                    <a href="https://www.instagram.com/"><i className="fa-brands fa-instagram"></i></a>
                                    <a href="https://www.behance.com/"><i className="fa-brands fa-behance"></i></a>
                ...
                <div className="col-xl-4 col-md-6 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.8s">
                    <div className="blog-content blog-content-inner">
                        <div className="blog-thumb mega-hover fix cover">
                            <img  src="/demo-01/assets/img/blog/blog-6.jpg" alt="" />
                        </div>
                        <div className="blog-content-text">
                            <div className="date-admin">
                                <a href="/demo-01/blog-details"><i className="fa-solid fa-calendar-days"></i>10 March, 2026</a>
                            ...
                            <div className="share-area">
                                <div className="share share-icon6">
                                    <i className="fa-solid fa-share-nodes"></i>
                                    <div className="social-wrapper  social-wrapper-toggle6">
                                  <a href="https://www.facebook.com/"><i className="fa-brands fa-facebook-f"></i></a>
                                    <a href="https://www.x.com/"><i className="fa-brands fa-twitter"></i></a>
                                    <a href="https://www.instagram.com/"><i className="fa-brands fa-instagram"></i></a>
                                    <a href="https://www.behance.com/"><i className="fa-brands fa-behance"></i></a>
