  ...
  return (
    ...
    <section className="breadcumb-wrapper text-center" data-bg-src="/demo-01/assets/img/breadcumb/breadcumb-bg.png">
            <div className="wow img-custom-anim-scale" data-wow-duration="1.5s" data-wow-delay="0s">
                <h2 className="breadcumb-title">practice areas</h2>
            <p className="breadcumb-text"><a href="/demo-01/index-2">home </a> <i className="fa-regular fa-angles-right"></i>practice areas</p>
            </div>
    </section>
    {/*============ Breadcumb End============ */}
     {/*============ Practice Start ============ */}
            ...
            <div className="row gx-0 ">
                ...
                <div className="col-xl-6 col-lg-5 wow img-custom-anim-right" data-wow-duration="1.5s" data-wow-delay="0.1s">
                    <div className="service-btn w-100  mt-40">
                        <a href="/demo-01/practice-details" className="main-btn">More Services 
                ...
                <div className="row gx-0 service-1">
                    ...
                    <div className="service-content one">
                        ...
                        <div  className="service-thumb mega-hover one">
