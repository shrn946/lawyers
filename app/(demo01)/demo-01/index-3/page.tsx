...
export default function Page() {
  return (
    ...
    {/*============ momile menu End ============ */}
     {/*============ Header Start============ */}
    <header>
        <div className="header p-absolute two">
            <div className="header-menu-area two ">
    ...
    <main>
    {/*============ Hero Start ============ */}
        <section className="hero   hero-2" data-bg-src="/demo-01/assets/img/hero/hero-2-bg.png">
            <div className="container h-100">
                <div className="row gx-0">
                    <div className="col-lg-12">
                        <div className="hero-title hero-title-2 sec-title text-center " >
                            <h1 className="wow img-custom-anim-left" data-wow-duration="3s" data-wow-delay="0.1s">Justice Guide Compassion  <br  />&<span className="highlight ml-20">Excellence</span></h1>
                            <p className="wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="1s" >We focus on achieving amicable solutions ?</p>
                            <div className="hero-btn-area wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="1.3s">
                                <a href="/demo-01/contact" className="main-btn">appointment<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="col-lg-12">
                       <div className="hero-thumb-wrapper hero-thumb-wrapper-2">
                         <div className="hero-thumb two cover wow tpFadeInUp" data-wow-duration="2s" data-wow-delay="2s">
                            <img  src="/demo-01/assets/img/hero/hero-2.png" alt="" />
                        </div>
                       </div>
                    </div>
                </div>
    ...
    <div className="banner two">
               <div className="banner-slider">
                <div className="slider slider-1">
                    <div className="img">
                        <img  src="/demo-01/assets/img/banner/2/banner-2(1).svg" alt="" />
                    </div>
                    <div className="img">
                        <img  src="/demo-01/assets/img/banner/2/banner-2(2).svg" alt="" />
                    </div>
                    <div className="img">
                        <img  src="/demo-01/assets/img/banner/2/banner-2(3).svg" alt="" />
                    </div>
                    <div className="img">
                        <img  src="/demo-01/assets/img/banner/2/banner-2(4).svg" alt="" />
                    </div>
                    <div className="img">
                        <img  src="/demo-01/assets/img/banner/2/banner-2(5).svg" alt="" />
                    </div>
                    <div className="img">
                        <img  src="/demo-01/assets/img/banner/2/banner-2(6).svg" alt="" />
                    </div>
                    <div className="img">
                        <img  src="/demo-01/assets/img/banner/2/banner-2(7).svg" alt="" />
                    </div>
                    <div className="img">
                        <img  src="/demo-01/assets/img/banner/2/banner-2(8).svg" alt="" />
                    </div>
                    <div className="img">
                        <img  src="/demo-01/assets/img/banner/2/banner-2(9).svg" alt="" />
                    </div>
                </div>
    ...
    <section className="about two p-relative sec-pb-pt-120">
        <div className="container">
            
            <div className="row">
                <div className="col-xl-4 col-lg-5 wow tpFadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.1s">
                    <div className="about-thumb two w-100   cover">
                        <img  src="/demo-01/assets/img/about/about2-thumb.jpg" alt="" />
                    </div>
                </div>
                <div className=" col-xl-8  col-lg-7">
                    <div className="about-content two">
                        <div className=" about-title sec-title">
                            ...
                            <p className="gray">We specialize in areas such as family law, corporate law, personal injury, criminal defense, and estate planning details related to your case for thorough through any relevant documents assessment depending on the service.</p>
                        </div>
                        ...
                        <div className="about-btn-area d-flex mt-40 ">
                            ...
                            <div className="about-thumb2  two  wow tpFadeInRight" data-wow-duration="1.5s" data-wow-delay="0.1s">
                ...
                <div className="col-xl-8 col-lg-12">
                  <div className="counter-2">
                    <div className="counter-2-item text-center">
        ...
        <div className="justice-img p-absolute wow tpFadeInRight" data-wow-duration="1.5s" data-wow-delay="0.1s">
            <img  src="/demo-01/assets/img/about/justice.png" alt="" />
        </div>
    </section>
    {/*============ About End ============ */}
    {/*============ Practice Start ============ */}

    <section className="practice sec-pb-pt" data-bg-src="/demo-01/assets/img/Service/practice-bg-2.png"> 
        <div className="container">
             <div className="sec-title text-center mb-50 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.1s">
                        <span className="sub-title two">area of practice</span>
                        <h2>We are here to help you <br  /> get sealift</h2>
                    </div>
            <div className="row gx-lg-3 gx-xl-4">
                <div className="col-lg-8 wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
                    <div className="practice-content practice-content-1 two d-flex justify-between md-reverse">
                        <div className="practice-text practice-text-2 one">
                            <a href="/demo-01/practice-details" className="practice-content-title">Business and Corporate Law</a>
                            <p>You can schedule a consultation via our website, by kinds phone or by visiting our office during business hours and details related to your case for assessment..</p>
                            <a href="/demo-01/practice-details" className="arrow-btn"> <svg width="30" height="15" viewBox="0 0 30 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="practice-thumb one mega-hover  cover">
                            <img  src="/demo-01/assets/img/Service/practice2-2.jpg" alt="" />
                        </div>
                    </div>
                </div>
                <div className="col-lg-4 wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.7s">
                    <div className="practice-content practice-content-2 two ">
                        <div className="practice-text practice-text-2 two">
                            <a href="/demo-01/practice-details" className="practice-content-title">Real Estate Transactions</a>
                            <p>We are committed to serving our community and offer pro bono services to individuals any who meet certain eligibility criteria.</p>
                            <a href="/demo-01/practice-details" className="arrow-btn"><svg width="30" height="15" viewBox="0 0 30 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M29.3681 8.08065C29.7592 7.69066 29.76 7.0575 29.37 6.66644L23.0147 0.293834C22.6247 -0.0972214 21.9916 -0.0980823 21.6005 0.291911C21.2095 0.681904 21.2086 1.31507 21.5986 1.70612L27.2478 7.37066L21.5832 13.0198C21.1922 13.4098 21.1913 14.043 21.5813 14.434C21.9713 14.8251 22.6045 14.8259 22.9955 14.436L29.3681 8.08065ZM-1.68488e-05 8.33362L28.6606 8.37258L28.6633 6.37259L0.0027024 6.33362L-1.68488e-05 8.33362Z"/>
                                </svg></a>
                ...
                <div className="col-lg-4 wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
                    <div className="practice-content practice-content-3 two ">
                        <div className="practice-text practice-text-2 three">
                            
                            <a href="/demo-01/practice-details" className="practice-content-title">Civil Rights and Liberties</a>
                            <p>We offer flat fees, hourly rates, and  services contingency-based pricing depending on the service. efficiently as possible.</p>
                            <a href="/demo-01/practice-details" className="arrow-btn"> <svg width="30" height="15" viewBox="0 0 30 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M29.3681 8.08065C29.7592 7.69066 29.76 7.0575 29.37 6.66644L23.0147 0.293834C22.6247 -0.0972214 21.9916 -0.0980823 21.6005 0.291911C21.2095 0.681904 21.2086 1.31507 21.5986 1.70612L27.2478 7.37066L21.5832 13.0198C21.1922 13.4098 21.1913 14.043 21.5813 14.434C21.9713 14.8251 22.6045 14.8259 22.9955 14.436L29.3681 8.08065ZM-1.68488e-05 8.33362L28.6606 8.37258L28.6633 6.37259L0.0027024 6.33362L-1.68488e-05 8.33362Z"/>
                                </svg></a>
                ...
                <div className="col-lg-8 wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.7s">
                    <div className="practice-content practice-content-4 two d-flex md-flex-col">
                        <div className="practice-thumb four mega-hover   cover">
                            <img  src="/demo-01/assets/img/Service/practice2-1.jpg" alt="" />
                        </div>
                        <div className="practice-text practice-text-2 four">
                           <a href="/demo-01/practice-details" className="practice-content-title">Immigration Law Services</a>
                            <p>We specialize in areas such as family law, corporate law an personal injury, criminal defense, and estate planning. by is phone, or by visiting our office hours.</p>
                            <a href="/demo-01/practice-details" className="arrow-btn"> <svg width="30" height="15" viewBox="0 0 30 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M29.3681 8.08065C29.7592 7.69066 29.76 7.0575 29.37 6.66644L23.0147 0.293834C22.6247 -0.0972214 21.9916 -0.0980823 21.6005 0.291911C21.2095 0.681904 21.2086 1.31507 21.5986 1.70612L27.2478 7.37066L21.5832 13.0198C21.1922 13.4098 21.1913 14.043 21.5813 14.434C21.9713 14.8251 22.6045 14.8259 22.9955 14.436L29.3681 8.08065ZM-1.68488e-05 8.33362L28.6606 8.37258L28.6633 6.37259L0.0027024 6.33362L-1.68488e-05 8.33362Z"/>
                                </svg></a>
            ...
            <div className="practice-btn-area w-100 text-center mt-30">
                <a href="/demo-01/practice-details" className="main-btn wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0s">More Services<svg width="16" height="11" viewBox="0 0 16 11" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="container">
            <div className="row gx-0">
                ...
                <div className="col-lg-7  wow img-custom-anim-right" data-wow-duration="1.5s" data-wow-delay="0.1s">
                    <ul className="cases-filters" id="myTab" role="tablist">
                                ...
                                <div className="swiper-wrapper ">
                                    <div className="swiper-slide wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.7s">
                                        <div className="cases-item  ">
                                                <div className="cases-thumb   cover">
    ...
    {/*============ Case-Studies End ============ */}
     {/*============ Appoiment Start ============ */}
    <section className="appoiment p-relative fix sec-pb-pt" data-bg-src="/demo-01/assets/img/appoiment/appoiment-bg-1.png">
        <div className="container">
            <div className="row">
                <div className=" col-xl-5 col-lg-6  wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.1s">
                    <form action="#" className="appoiment-form text-center ">
                        <h3>Make Appointment</h3>
                        <div className="appoiment-form-item mt-40">
                            <input  type="text" placeholder="your name" />
                            <i className="fa-regular fa-user"></i>
                        </div>
                        <div className="appoiment-form-item">
                        ...
                        <div className="appoiment-form-item">
                         <textarea name="message" id="text-area" placeholder="Write Message..."></textarea>
                ...
                <div className="col-xl-5 col-lg-6 flex item-center">
                    <div className="appoiment-content">
                        <div className="sec-title">
                            <span className="sub-title"><i></i>Make Appointment</span>
                            <h2 className="white-color">Get Appointment Meet For Consultation</h2>
                            <p>We specialize in areas such as family law, corporate law, personal a injury, criminal defense, and estate planning  by phone, or by kinds visiting our office during business hours etails related to your case for a thorough assessment</p>
                        </div>
                        <span className="call-us">Or You May <a href="tel:+(163)556506979" className="highlight">Call Us</a> For Appointment</span>
                        <a href="tel:+(163)556506979" className="main-btn">+(163)-5565-06979</a>
                    </div>
                </div>
            </div>
        </div>
        <div className="appoiment-thumb p-absolute lg-none  wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.1s">
            <img  src="/demo-01/assets/img/appoiment/appoiment-1.png" alt="" />
        </div>
    </section>
    {/*============ Appoiment End ============ */}
    {/*============ Process Start ============ */}
    <section className="process two sec-pb-pt" >
        <div className="container">
            <div className="process-title-wrapper two ">
                <div className="sec-title  wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.1s">
                <span className="sub-title ">Working Process</span>
                <h2 >Empowering You Through Legal Challenges </h2> 
                </div>
                <div className="client  wow img-custom-anim-right" data-wow-duration="1.5s" data-wow-delay="0.1s">
                    <div className="user"><img  src="/demo-01/assets/img/process/User.png" alt="" /></div>
                    <div className="text">
                        <span>2000+</span>
                        <p>happy clients</p>
                    </div>
            ...
            <div className="row">
                <div className="col-lg-6 wow img-custom-anim-right" data-wow-duration="1.5s" data-wow-delay="0.5s">
                    <div className="process-video two cover p-relative" >
                        <img  src="/demo-01/assets/img/process/process-2.jpg" alt="" />
                    ...
                    <div className="side-text cover">
                        <img  src="/demo-01/assets/img/process/Lawyer-Attorney.png" alt="" />
                    </div>
                </div>
                </div>
                <div className="col-lg-6 wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.5s">
                    <div className="process-content two">
                    
                    <div className="process-content-item two d-flex">
                        <div className="icon">
                            <img  src="/demo-01/assets/img/process/process-icon-1.svg" alt="" />
                        </div>
                        <div className="text">
                            <span className="number">01.</span>
                            <h3>Initial Consuliation</h3>
                            <p>Our fees vary depending on the complexity and nature of the legal services required  understanding situation better and provide effective assistance.</p>
                        </div>
                    </div>
                    <div className="process-content-item two d-flex">
                        <div className="icon">
                            <img  src="/demo-01/assets/img/process/process-icon-2.svg" alt="" />
                        </div>
                        <div className="text">
                            <span className="number">02.</span>
                            <h3>Case Evaluation</h3>
                            <p>We provide a wide range of legal services, including family is law, corporate advisory, criminal defense, estate planning any immigration assistance, personal injury.</p>
                        </div>
                    </div>
                    <div className="process-content-item two d-flex">
                        <div className="icon">
                        ...
                        <div className="text">
                            ...
                            <p>Please bring any relevant documents related to your legal any matter, such as contracts, court papers, identification, and is any correspondence pertinent case.</p>
                        </div>
                    </div>
    ...
    {/*============ Contact Start ============ */}
     <section className="contact text-center sec-pb-pt " data-bg-src="/demo-01/assets/img/contact/contact-bg-1.png">
        <div className=" contact-title sec-title text-center  wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.1s">
            <span className="sub-title two">contact us</span>
            <h2 className="white-color">Make an appointment for your free consultation right now.</h2>
            <p>We specialize in areas such as family law, corporate law, personal injury criminal defense, and estate planning.</p>
            <a href="/demo-01/contact" className="main-btn mt-40">contact us <svg width="16" height="11" viewBox="0 0 16 11" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M14.4375 6.37091C14.6861 6.37091 14.9246 6.27214 15.1004 6.09632C15.2762 5.92051 15.375 5.68205 15.375 5.43341C15.375 5.18477 15.2762 4.94631 15.1004 4.7705C14.9246 4.59468 14.6861 4.49591 14.4375 4.49591H0.937499C0.688858 4.49591 0.450401 4.59468 0.274586 4.7705C0.0987701 4.94631 -9.53674e-07 5.18477 -9.53674e-07 5.43341C-9.53674e-07 5.68205 0.0987701 5.92051 0.274586 6.09632C0.450401 6.27214 0.688858 6.37091 0.937499 6.37091H14.4375Z" fill="white"/>
            <path d="M9.9375 10.8709C10.0605 10.8714 10.1824 10.847 10.2958 10.7994C10.4092 10.7517 10.5118 10.6816 10.5975 10.5934L15.0975 6.09338C15.1855 6.00745 15.2554 5.9048 15.3032 5.79146C15.3509 5.67811 15.3755 5.55637 15.3755 5.43338C15.3755 5.31039 15.3509 5.18865 15.3032 5.07531C15.2554 4.96196 15.1855 4.85931 15.0975 4.77338L10.5975 0.273381C10.5108 0.186708 10.4079 0.117956 10.2947 0.0710492C10.1814 0.0241424 10.0601 9.13242e-10 9.9375 0C9.81493 -9.13243e-10 9.69355 0.0241424 9.58031 0.0710492C9.46707 0.117956 9.36417 0.186708 9.2775 0.273381C9.19083 0.360053 9.12208 0.462948 9.07517 0.576191C9.02826 0.689434 9.00412 0.810808 9.00412 0.933381C9.00412 1.05595 9.02826 1.17733 9.07517 1.29057C9.12208 1.40381 9.19083 1.50671 9.2775 1.59338L13.11 5.43338L9.2775 9.27338C9.14755 9.40447 9.05919 9.57099 9.02349 9.75209C8.9878 9.93318 9.00635 10.1208 9.07683 10.2914C9.14731 10.462 9.26658 10.608 9.41969 10.7111C9.57279 10.8141 9.75292 10.8697 9.9375 10.8709Z" fill="white"/>
            </svg>
            </a>
    ...
    {/*============ Contact End ============ */}
    {/*============ History Start ============ */}
     <div className="history sec-pb-pt" data-bg-src="/demo-01/assets/img/history/history-bg-1.png">
        <div className="container">
            <div className=" history-title sec-title  wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.1s">
                <div>
                    <span className="sub-title">our history</span>
                    <h2>we are the most well known law farm</h2>
                </div>
                <p className="article gray">Our fees vary depending on the complexity a and nature of the legal services required offer transparent pricing  discuss  </p>
            </div> 
            <div className="history-content  wow img-custom-anim-left" data-wow-duration="2.5s" data-wow-delay="0.6s">
                <div className="history-item text-center p-relative">
                    <h3>We  Are Started New At Core law</h3>
                    <p>We provide a wide range of legal services including family law kinds to corporate advisory estate</p>
                    <span className="year p-absolute">2019</span>
                </div>
                <div className="history-angels">
                    <img  src="/demo-01/assets/img/icon/double-angle-2.svg" alt="" />
                </div>
                <div className="history-item text-center p-relative">
                    <h3>Best law Frim Company of the law</h3>
                    <p>We provide a wide range of legal services including family law kinds to corporate advisory estate</p>
                    <span className="year p-absolute">2021</span>
                </div>
                <div className="history-angels">
                    <img  src="/demo-01/assets/img/icon/double-angle-2.svg" alt="" />
                </div>
                <div className="history-item text-center p-relative">
                    ...
                    <p>We provide a wide range of legal services including family law kinds to corporate advisory estate</p>
                    <span className="year p-absolute">2024</span>
                </div>
            </div>
        </div>
    </div>
    {/*============ History End ============ */}
    {/*============ Blog Start ============ */}
    <section className="blog sec-pb-pt">
        <div className="container">
            <div className="sec-title text-center mb-50 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.1s">
            ...
            <div className="row gx-xl-4 gx-lg-2 blog-1">
                <div className="col-lg-4 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.3s">
                    <div className="blog-content two">
                        
                        <div className="blog-content-text two">
                            <div className="date-admin">
                                <a href="/demo-01/blog-details"><i className="fa-regular fa-comments"></i>02 comments</a>
                                <a href="/demo-01/blog-details"><i className="fa-regular fa-user"></i>Admin</a>
                            </div>
                            <a href="/demo-01/blog-details" className="blog-content-title two">Protecting Your Rights Securing Your property Future</a>
                            
                        </div>
                        <div className="blog-thumb two  cover">
                            <div className="img-wrap">
                                <div className="img mega-hover ">
                                <img   src="/demo-01/assets/img/blog/blog2-1.jpg" alt="" />
                            </div>
                            </div>
                            <div className="blog-btn-area">
                                <a href="/demo-01/blog-details" className="blog-btn"><svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M7.125 7.125L2.125 12.125L1.4375 12.8438L0 11.4062L0.71875 10.7188L5 6.40625L0.71875 2.125L0 1.40625L1.4375 0L2.125 0.71875L7.125 5.71875L7.84375 6.40625L7.125 7.125ZM13.125 7.125L8.125 12.125L7.4375 12.8438L6 11.4062L6.71875 10.7188L11 6.40625L6.71875 2.125L6 1.40625L7.4375 0L8.125 0.71875L13.125 5.71875L13.8438 6.40625L13.125 7.125Z" fill="white"/>
                                </svg>
                                </a>
                            </div>
                            <span className="date"> 10 <br  /> <b>oct</b></span>
                        </div>
                    </div>
                </div>
                <div className="col-lg-4 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.7s">
                    <div className="blog-content two">
                        ...
                        <div className="blog-content-text two">
                            ...
                            <a href="/demo-01/blog-details" className="blog-content-title two">Empowering You Through Legal  drafting & Challenges</a>
                            
                        </div>
                        <div className="blog-thumb two  cover">
                            <div className="img-wrap">
                                <div className="img mega-hover ">
                                <img   src="/demo-01/assets/img/blog/blog2-3.jpg" alt="" />
                            </div>
                            </div>
                            <div className="blog-btn-area">
                              <a href="/demo-01/blog-details" className="blog-btn"><svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="col-lg-4 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="1.2s">
                    <div className="blog-content two">
                        ...
                        <div className="blog-content-text two">
                            ...
                            <a href="b.html" className="blog-content-title two">Defending Your Rights with kind Excellence as possible</a>
                            
                        </div>
                        <div className="blog-thumb two  cover">
                            <div className="fix">
                                <div className="img  mega-hover ">
                                <img   src="/demo-01/assets/img/blog/blog2-2.jpg" alt="" />
                            </div>
                            </div>
                            <div className="blog-btn-area">
                              <a href="/demo-01/blog-details" className="blog-btn"><svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
