...
<path d="M11.25 14.4375C11.373 14.438 11.4949 14.4137 11.6083 14.366C11.7217 14.3183 11.8243 14.2483 11.91 14.16L16.41 9.66003C16.498 9.57411 16.5679 9.47145 16.6157 9.35811C16.6634 9.24476 16.688 9.12302 16.688 9.00003C16.688 8.87704 16.6634 8.7553 16.6157 8.64196C16.5679 8.52861 16.498 8.42596 16.41 8.34003L11.91 3.84003C11.8233 3.75336 11.7204 3.68461 11.6072 3.6377C11.494 3.59079 11.3726 3.56665 11.25 3.56665C11.1274 3.56665 11.0061 3.59079 10.8928 3.6377C10.7796 3.68461 10.6767 3.75336 10.59 3.84003C10.5033 3.9267 10.4346 4.0296 10.3877 4.14284C10.3408 4.25608 10.3166 4.37746 10.3166 4.50003C10.3166 4.6226 10.3408 4.74398 10.3877 4.85722C10.4346 4.97046 10.5033 5.07336 10.59 5.16003L14.4225 9.00003L10.59 12.84C10.4601 12.9711 10.3717 13.1376 10.336 13.3187C10.3003 13.4998 10.3189 13.6874 10.3893 13.858C10.4598 14.0286 10.5791 14.1746 10.7322 14.2777C10.8853 14.3808 11.0654 14.4364 11.25 14.4375Z" fill="white"/>
    ...
    <section className="breadcumb-wrapper text-center" data-bg-src="/demo-01/assets/img/breadcumb/breadcumb-bg.png">
           <div className="wow img-custom-anim-scale" data-wow-duration="1.5s" data-wow-delay="0s">
             <h2 className="breadcumb-title">our attorney details</h2>
            <p className="breadcumb-text"><a href="/demo-01/index-2">home </a> <i className="fa-regular fa-angles-right"></i>our attorney details</p>
           </div>
    </section>
    {/*============ Breadcumb End============ */}
    {/*============ Expart Start ============ */}
        ...
        <div className="container">
            <div className="row">
                <div className="col-lg-6 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.5s">
                    <div className="expart-details-thumb cover fix">
                        <img  src="/demo-01/assets/img/expart/expart-details.jpg" alt="" />
                    </div>
                </div>
                <div className="col-lg-6 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.8s">
                    <div className="expart-details-contact-info">
                        <div className="name">
                            <span>Marvin McKinney</span>
                            <p className="highlight">CEO & CO Founder</p>
                        </div>
                        ...
                        <p>Professional Cleaning High-pressure cleaning service for exterior surfaces such as driveways sidewalks patios decks and building exteriors This service removes dirt mold. </p>
                       
                        <ul>
                            <li><span>phone number:</span> <a href="%2b00(573)59724.html">+00 (573) 597 24</a></li>
                            <li><span>Email:</span> <a href="http://www.gmail.com/">Darlene Robertson@gmail.com</a></li>
                            <li><span>Website:</span> <a href="http://www.cameron.com/">http://www.cameron.com</a></li>
                            <li><span>Address:</span> <p>2464 Royal Ln. Mesa, New Jersey 45463</p></li>
                            <li><span>Experience:</span> <p>22 Years</p></li>
                        </ul>
                        
                    </div>
                </div>
                <div className="col-lg-6 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0s">
                    <div className="expart-details-information">
                        <h3>Personal Information</h3>
                        <p>Since joining Biddut in 2009, Matilda has helped turn the company from a group of bright technology minds working with startups into a global Digital Product Engineering Services leader helping Fortune 500 companies on their innovation agenda. In Matilda`s time as President and CEO of company <br  /><br  />
                        growth in while developing a culture that fosters engaged employees around innovation. <br  />
                        Matilda is a frequent speaker on the topics of global innovation and digital disruption. She is also an avid cook and history buff. You can find him dining late at night with the chefs of the hotels where he stays during his travels, or reading in his home library.</p>
                    </div>
                </div>
                <div className="col-lg-6 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0s">
                    <div className="expart-details-skill">
                        <h3>Personal Skills</h3>
                        <p>Using EPA-approved disinfectants on high touch surfaces such as doorknobs light switches, countertops, and electronic devices</p>
                        <div className="expart-details-skill-item">
                            <span>Defense Counsels</span>
                            <div className="expart-details-skill-range">
                                <span className="percentage one">95%</span>
                            </div>
                        </div>
                        <div className="expart-details-skill-item">
                            <span>Legal Counsels</span>
                            <div className="expart-details-skill-range two">
                                <span className="percentage">65%</span>
                            </div>
                        </div>
                        <div className="expart-details-skill-item">
                            <span>Education Counsels</span>
                            <div className="expart-details-skill-range three">
                ...
                <div className="col-lg-12 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0s">
                     <div className="contact-appointment expart text-center">
                        <h3>Contact Me Now</h3>
                    <form action="#" className="appoiment-form expart ">
                        ...
                        <div className="appoiment-form-item fix">
                        ...
                        <div className="appoiment-form-item appoiment-btn">
