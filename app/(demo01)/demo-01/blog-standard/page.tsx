 ...
 {/*============ Breadcumb Start ============ */}
    <section className="breadcumb-wrapper text-center" data-bg-src="/demo-01/assets/img/breadcumb/breadcumb-bg.png">
            <div className="wow img-custom-anim-scale" data-wow-duration="1.5s" data-wow-delay="0s">
                <h2 className="breadcumb-title">Blog Standard</h2>
            <p className="breadcumb-text"><a href="/demo-01/index-2">home </a> <i className="fa-sharp fa-regular fa-angles-right"></i>Blog standard</p>
            </div>
    </section>
 {/*============ Breadcumb End============ */}
                    ...
                    <div className="col-lg-8">
                        <div className="blog-details-left">
                            <div className="blog-details-content">
                                <div className="blog-details-thumb1  p-relative wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.1s">
                                   <div className="thumb fix cover">
                                     <img  src="/demo-01/assets/img/blog/blog-starndard-thumb-1.jpg" alt="" />
                                   </div>
                                ...
                                <div className="blog-details-text wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
                                    ...
                                    <a href="/demo-01/blog-details" className="sec-btn mt-30"><span className="arrow"><i className="fa-sharp fa-regular fa-angles-right"></i></span> <span>read more</span></a>
                                </div>
                            </div>
                            <div className="blog-details-content">
                                <div className="blog-details-thumb1  p-relative wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.1s">
                                   <div className="thumb fix cover">
                                     <img  src="/demo-01/assets/img/blog/blog-starndard-thumb-3.jpg" alt="" />
                                   </div>
                                    <a href="/demo-01/blog-details" className="date p-absolute"> 10 <br  /> <span>Oct</span></a>
                                </div>
                                <div className="blog-details-text wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
                            ...
                            <div className="blog-details-content">
                                <div className="blog-details-thumb1  p-relative wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.1s">
                                   <div className="thumb fix cover">
                                     <img  src="/demo-01/assets/img/blog/blog-starndard-thumb-2.jpg" alt="" />
                                   </div>
                                    <a href="/demo-01/blog-details" className="date p-absolute"> 10 <br  /> <span>Oct</span></a>

                                     <div className="play-btn-area p-absolute">
                                    <a href="https://www.youtube.com/watch?v=zYRgrWtzpc0" className="video-play popup-video"><i className="fa-solid fa-play"></i></a>
                                </div>
                                </div>
                                </div>
                                <div className="blog-details-text wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
                            ...
                            <div className="blog-details-content">
                                <div className="blog-details-thumb1  p-relative wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.1s">
                                   <div className="thumb blog-standard fix cover">
                                     <img  src="/demo-01/assets/img/blog/blog-starndard-thumb-4.jpg" alt="" />
                                     <img  src="/demo-01/assets/img/blog/blog-starndard-thumb-3.jpg" alt="" />
                                     <img  src="/demo-01/assets/img/blog/blog-starndard-thumb-2.jpg" alt="" />
                                     <img  src="/demo-01/assets/img/blog/blog-starndard-thumb-1.jpg" alt="" />
                                   </div>
                                    <a href="/demo-01/blog-details" className="date p-absolute"> 10 <br  /> <span>Oct</span></a>
                                    <button className="blog-standard-next-btn"><svg width="25" height="15" viewBox="0 0 25 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0.292892 6.65691C-0.0976315 7.04743 -0.0976315 7.6806 0.292892 8.07112L6.65685 14.4351C7.04738 14.8256 7.68054 14.8256 8.07107 14.4351C8.46159 14.0446 8.46159 13.4114 8.07107 13.0209L2.41421 7.36401L8.07107 1.70716C8.46159 1.31664 8.46159 0.68347 8.07107 0.292946C7.68054 -0.0975785 7.04738 -0.0975785 6.65685 0.292946L0.292892 6.65691ZM25 7.36401V6.36401L1 6.36401V7.36401V8.36401L25 8.36401V7.36401Z" fill="white"/>
                                    </svg>

                                    </button>
                                    <button className="blog-standard-prev-btn">
                                        <svg width="25" height="15" viewBox="0 0 25 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M24.7071 6.65691C25.0976 7.04743 25.0976 7.6806 24.7071 8.07112L18.3431 14.4351C17.9526 14.8256 17.3195 14.8256 16.9289 14.4351C16.5384 14.0446 16.5384 13.4114 16.9289 13.0209L22.5858 7.36401L16.9289 1.70716C16.5384 1.31664 16.5384 0.68347 16.9289 0.292946C17.3195 -0.0975785 17.9526 -0.0975785 18.3431 0.292946L24.7071 6.65691ZM0 7.36401L0 6.36401L24 6.36401V7.36401V8.36401L0 8.36401L0 7.36401Z"/>
                                        </svg>
                            ...
                            <div className="blog-details-pegination">
                                <ul>
