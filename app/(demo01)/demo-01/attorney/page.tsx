...
<path d="M11.25 14.4375C11.373 14.438 11.4949 14.4137 11.6083 14.366C11.7217 14.3183 11.8243 14.2483 11.91 14.16L16.41 9.66003C16.498 9.57411 16.5679 9.47145 16.6157 9.35811C16.6634 9.24476 16.688 9.12302 16.688 9.00003C16.688 8.87704 16.6634 8.7553 16.6157 8.64196C16.5679 8.52861 16.498 8.42596 16.41 8.34003L11.91 3.84003C11.8233 3.75336 11.7204 3.68461 11.6072 3.6377C11.494 3.59079 11.3726 3.56665 11.25 3.56665C11.1274 3.56665 11.0061 3.59079 10.8928 3.6377C10.7796 3.68461 10.6767 3.75336 10.59 3.84003C10.5033 3.9267 10.4346 4.0296 10.3877 4.14284C10.3408 4.25608 10.3166 4.37746 10.3166 4.50003C10.3166 4.6226 10.3408 4.74398 10.3877 4.85722C10.4346 4.97046 10.5033 5.07336 10.59 5.16003L14.4225 9.00003L10.59 12.84C10.4601 12.9711 10.3717 13.1376 10.336 13.3187C10.3003 13.4998 10.3189 13.6874 10.3893 13.858C10.4598 14.0286 10.5791 14.1746 10.7322 14.2777C10.8853 14.3808 11.0654 14.4364 11.25 14.4375Z" fill="white"/>
    ...
    <section className="breadcumb-wrapper text-center" data-bg-src="/demo-01/assets/img/breadcumb/breadcumb-bg.png">
            <div className="wow img-custom-anim-scale" data-wow-duration="1.5s" data-wow-delay="0s">
                <h2 className="breadcumb-title">our attorney</h2>
            <p className="breadcumb-text"><a href="/demo-01/index-2">home </a> <i className="fa-regular fa-angles-right"></i>our attorney</p>
            </div>
    </section>
    {/*============ Breadcumb End============ */}
    {/*============ About Start ============ */}
    ...
    <section className="expart sec-pb-pt">
        <div className="container">
            <div className="sec-title text-center mb-60 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.5s">
                <span className="sub-title"><i></i>Expert Attorneys <i></i></span>
                <h2>Meet Our Top Attorneys</h2>
            </div>
            <div className="row gx-0 ">
                <div className="col-lg-6 wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
                   <div className="expart-content fix one">
                ...
                <div className="col-lg-6 wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.8s">
                    <div className="expart-content fix two">
                        <div className="expart-item ">
                        <div className="expart-img mega-hover fix cover">
                ...
                <div className="col-lg-6 wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
                    <div className="expart-content fix content-1">
                        <div className="expart-item ">
                        <div className="expart-img mega-hover fix cover">
                ...
                <div className="col-lg-6 wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.8s">
                    <div className="expart-content fix content-2">
                        <div className="expart-item">
                        <div className="expart-img mega-hover fix cover">
                ...
                <div className="col-lg-6 wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
                    <div className="expart-content fix three">
                        <div className="expart-item ">
                        <div className="expart-img mega-hover fix cover">
                            <img  src="/demo-01/assets/img/expart/expart5.jpg" alt="" />
                        </div>
                        <div className="text">
                            <a href="/demo-01/attorney-details" className="expart-item-title">Marvin McKinney</a>
                ...
                <div className="col-lg-6 wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.8s">
                    <div className="expart-content fix four">
                        <div className="expart-item">
                        <div className="expart-img mega-hover fix cover">
                            <img  src="/demo-01/assets/img/expart/expart6.jpg" alt="" />
                        </div>
                        <div className="text">
                            <a href="/demo-01/attorney-details" className="expart-item-title">Kathryn Murphy</a>
                            <span className="highlight">Financial Lawyer</span>
                            <p>Please bring all relevant kinds contracts, correspondence a and a summary </p>
                            <div className="social-wrapper">
                                <a href="https://www.facebook.com/"> <i className="fa-brands fa-facebook-f"></i></a>
