  ...
  return (
    ...
    <section className="breadcumb-wrapper text-center" data-bg-src="/demo-01/assets/img/breadcumb/breadcumb-bg.png">
           <div className="wow img-custom-anim-scale" data-wow-duration="1.5s" data-wow-delay="0s">
             ...
             <p className="breadcumb-text"><a href="/demo-01/index-2">home </a><i className="fa-regular fa-angles-right"></i>about us</p>
           </div>
    </section>
    {/*============ Breadcumb End============ */}
    {/*============ About Start ============ */}
    <section className="about two about-inner p-relative sec-pb-pt">
        <div className="container">
            
            <div className="row">
                <div className="col-xl-4 col-lg-5 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.5s">
                    <div className="about-thumb two w-100 fix cover">
                        <img  src="/demo-01/assets/img/about/about2-thumb.jpg" alt="" />
                    </div>
                </div>
                <div className=" col-xl-8  col-lg-7 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.5s">
                    <div className="about-content">
                        <div className=" about-title sec-title">
                            <span className="sub-title"> about us</span>
                            <h2>We are the Leading Law Firm for Annual revenues</h2>
                            <p className="black">We specialize in areas such as family law, corporate law, personal injury, criminal defense, and estate planning details related to your case for thorough through any relevant documents assessment depending on the service.</p>
                        </div>
                       
                        <div className="about-btn-area d-flex mt-40 ">
                            <a href="/demo-01/about" className="main-btn mr-20">more about<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15.75 9.9375C15.9986 9.9375 16.2371 9.83873 16.4129 9.66291C16.5887 9.4871 16.6875 9.24864 16.6875 9C16.6875 8.75136 16.5887 8.5129 16.4129 8.33709C16.2371 8.16127 15.9986 8.0625 15.75 8.0625H2.25C2.00136 8.0625 1.7629 8.16127 1.58709 8.33709C1.41127 8.5129 1.3125 8.75136 1.3125 9C1.3125 9.24864 1.41127 9.4871 1.58709 9.66291C1.7629 9.83873 2.00136 9.9375 2.25 9.9375H15.75Z" fill="white"/>
                            <path d="M11.25 14.4375C11.373 14.438 11.4949 14.4137 11.6083 14.366C11.7217 14.3183 11.8243 14.2483 11.91 14.16L16.41 9.66003C16.498 9.57411 16.5679 9.47145 16.6157 9.35811C16.6634 9.24476 16.688 9.12302 16.688 9.00003C16.688 8.87704 16.6634 8.7553 16.6157 8.64196C16.5679 8.52861 16.498 8.42596 16.41 8.34003L11.91 3.84003C11.8233 3.75336 11.7204 3.68461 11.6072 3.6377C11.494 3.59079 11.3726 3.56665 11.25 3.56665C11.1274 3.56665 11.0061 3.59079 10.8928 3.6377C10.7796 3.68461 10.6767 3.75336 10.59 3.84003C10.5033 3.9267 10.4346 4.0296 10.3877 4.14284C10.3408 4.25608 10.3166 4.37746 10.3166 4.50003C10.3166 4.6226 10.3408 4.74398 10.3877 4.85722C10.4346 4.97046 10.5033 5.07336 10.59 5.16003L14.4225 9.00003L10.59 12.84C10.4601 12.9711 10.3717 13.1376 10.336 13.3187C10.3003 13.4998 10.3189 13.6874 10.3893 13.858C10.4598 14.0286 10.5791 14.1746 10.7322 14.2777C10.8853 14.3808 11.0654 14.4364 11.25 14.4375Z" fill="white"/>
                            </svg>
</a>
                            ...
                            <div className="about-thumb2  two  ">
                                <img  src="/demo-01/assets/img/about/about2-thumb2.png" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col-lg-8 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.5s">
        ...
        <div className="justice-img p-absolute wow tpFadeInRight" data-wow-duration="1.5s" data-wow-delay="0.5s">
    ...
    {/*============ Contact Start ============ */}
     <section className="contact-3 " data-bg-src="/demo-01/assets/img/contact/contact-bg-2.png">
        <div className="container">
            ...
            <a href="/demo-01/contact" className="main-btn mt-40">explore More<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M15.75 9.9375C15.9986 9.9375 16.2371 9.83873 16.4129 9.66291C16.5887 9.4871 16.6875 9.24864 16.6875 9C16.6875 8.75136 16.5887 8.5129 16.4129 8.33709C16.2371 8.16127 15.9986 8.0625 15.75 8.0625H2.25C2.00136 8.0625 1.7629 8.16127 1.58709 8.33709C1.41127 8.5129 1.3125 8.75136 1.3125 9C1.3125 9.24864 1.41127 9.4871 1.58709 9.66291C1.7629 9.83873 2.00136 9.9375 2.25 9.9375H15.75Z" fill="white"/>
<path d="M11.25 14.4375C11.373 14.438 11.4949 14.4137 11.6083 14.366C11.7217 14.3183 11.8243 14.2483 11.91 14.16L16.41 9.66003C16.498 9.57411 16.5679 9.47145 16.6157 9.35811C16.6634 9.24476 16.688 9.12302 16.688 9.00003C16.688 8.87704 16.6634 8.7553 16.6157 8.64196C16.5679 8.52861 16.498 8.42596 16.41 8.34003L11.91 3.84003C11.8233 3.75336 11.7204 3.68461 11.6072 3.6377C11.494 3.59079 11.3726 3.56665 11.25 3.56665C11.1274 3.56665 11.0061 3.59079 10.8928 3.6377C10.7796 3.68461 10.6767 3.75336 10.59 3.84003C10.5033 3.9267 10.4346 4.0296 10.3877 4.14284C10.3408 4.25608 10.3166 4.37746 10.3166 4.50003C10.3166 4.6226 10.3408 4.74398 10.3877 4.85722C10.4346 4.97046 10.5033 5.07336 10.59 5.16003L14.4225 9.00003L10.59 12.84C10.4601 12.9711 10.3717 13.1376 10.336 13.3187C10.3003 13.4998 10.3189 13.6874 10.3893 13.858C10.4598 14.0286 10.5791 14.1746 10.7322 14.2777C10.8853 14.3808 11.0654 14.4364 11.25 14.4375Z" fill="white"/>
</svg>
</a>
            <a href="/demo-01/contact" className="main-btn two">contact us<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M15.75 9.9375C15.9986 9.9375 16.2371 9.83873 16.4129 9.66291C16.5887 9.4871 16.6875 9.24864 16.6875 9C16.6875 8.75136 16.5887 8.5129 16.4129 8.33709C16.2371 8.16127 15.9986 8.0625 15.75 8.0625H2.25C2.00136 8.0625 1.7629 8.16127 1.58709 8.33709C1.41127 8.5129 1.3125 8.75136 1.3125 9C1.3125 9.24864 1.41127 9.4871 1.58709 9.66291C1.7629 9.83873 2.00136 9.9375 2.25 9.9375H15.75Z" fill="white"/>
<path d="M11.25 14.4375C11.373 14.438 11.4949 14.4137 11.6083 14.366C11.7217 14.3183 11.8243 14.2483 11.91 14.16L16.41 9.66003C16.498 9.57411 16.5679 9.47145 16.6157 9.35811C16.6634 9.24476 16.688 9.12302 16.688 9.00003C16.688 8.87704 16.6634 8.7553 16.6157 8.64196C16.5679 8.52861 16.498 8.42596 16.41 8.34003L11.91 3.84003C11.8233 3.75336 11.7204 3.68461 11.6072 3.6377C11.494 3.59079 11.3726 3.56665 11.25 3.56665C11.1274 3.56665 11.0061 3.59079 10.8928 3.6377C10.7796 3.68461 10.6767 3.75336 10.59 3.84003C10.5033 3.9267 10.4346 4.0296 10.3877 4.14284C10.3408 4.25608 10.3166 4.37746 10.3166 4.50003C10.3166 4.6226 10.3408 4.74398 10.3877 4.85722C10.4346 4.97046 10.5033 5.07336 10.59 5.16003L14.4225 9.00003L10.59 12.84C10.4601 12.9711 10.3717 13.1376 10.336 13.3187C10.3003 13.4998 10.3189 13.6874 10.3893 13.858C10.4598 14.0286 10.5791 14.1746 10.7322 14.2777C10.8853 14.3808 11.0654 14.4364 11.25 14.4375Z" fill="white"/>
</svg>
</a>
    ...
    <section className="process two sec-pb-pt" >
        <div className="container">
            <div className="process-title-wrapper two mb-60">
                <div className="sec-title wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0s">
                <span className="sub-title ">Working Process</span>
                <h2 >Empowering You Through Legal Challenges </h2> 
                </div>
                <div className="client wow img-custom-anim-right" data-wow-duration="1.5s" data-wow-delay="0s">
            ...
            <div className="row">
                <div className="col-lg-6 wow img-custom-anim-right" data-wow-duration="1.5s" data-wow-delay="0s">
                ...
                <div className="col-lg-6 wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0s">
