...
export default function LawfinityTwoColumnPage() {
  return (
    <>
      <LawfinityPreloader />
      <LawfinityBackToTop />
      <LawfinityConsultationForm />
      <LawfinityPageBanner title="Two Column" currentPageName="Two Column" />
<div className=" blog-posts blogpage-section">
        <div className="container">
            <div className="row wow fadeInUp" style={{"visibility":"visible","animationName":"fadeInUp"}}>
                <div id="blog" className="col-xl-12">
                    <div className="row">
                        <div className="col-xl-6 col-lg-6 col-md-12" data-aos="fade-up" data-aos-duration="700">
                            <div className="blog-box twocolumn-blog float-left w-100 post-item mb-4">
                                <div className="post-item-wrap position-relative">
                                    <div className="post-image">
                                        <a href="#">
                                            <img alt="image" src="/demo-04/assets/images/post-featured.jpg" loading="lazy" />
                                        </a>
                                    </div>
                                    <div className="lower-portion">
                                        ...
                                        <p className="mb-0 text-size-16">Curabitur pulvinar euismod ante, ac sagittis ante
                                            posuere ac. Vivamus luctus commodo dolor porta feugiat. Fusce at velit id
                                            ligula ac sagittis ante posuere ac pharetra laoreet commodo dolor porta.</p>
                                    </div>
                                    ...
                                    <div id="blogslider" className="carousel slide" data-ride="carousel">
                                        <div className="carousel-inner">
                                            ...
                                            <div className="carousel-item active">
                                                <img src="/demo-04/assets/images/post-featured.jpg" alt="image" loading="lazy" />
                                            </div>
                                            <div className="carousel-item">
                        ...
                        <div className="col-xl-6 col-lg-6 col-md-12" data-aos="fade-up" data-aos-duration="700">
                            <div className="blog-box twocolumn-blog float-left w-100 post-item mb-4">
                                <div className="post-item-wrap position-relative">
                                    <div className="post-image">
                                        <a href="#"><img alt="image" src="/demo-04/assets/images/post-featured4.jpg" loading="lazy" /></a>
                                    </div>
                                    <div className="lower-portion">
                                        <div className="span-i-con">
                                        <i className="fa-solid fa-user"></i>
                            ...
                            <div className="blog-box twocolumn-blog float-left w-100 post-item mb-4">
                                <div className="post-item-wrap position-relative">
                                    <div className="post-audio position-relative">
                                        <a href="#"><img alt="image" src="/demo-04/assets/images/post-featured3.jpg" loading="lazy" /></a>
                                    ...
                                    <div className="infinite-blog float-left">
                                        <div className="lower-portion">
                                            ...
                                            <p className="mb-0 text-size-16">Curabitur pulvinar euismod ante, ac sagittis
                                                ante posuere ac. Vivamus luctus commodo dolor porta feugiat. Fusce at
                                                velit id ligula ac sagittis ante posuere ac pharetra laoreet commodo
                                                dolor porta.</p>
                                        </div>
                                        <div className="button-portion loadone_twocol">
                                            <div className="date">
