...
export default function PracticeAreasv24ColsPage() {
  return (
    <>
      <LawyersHeader headerType="header-1" />
      <PageBanner title="Practice Areas v2 4 Cols" subtitle="in business since 1970" />
			...
			<div className="container">
				<div className="row practice-items-holder-v2">
					...
					<div className="col-lg-3 col-md-6">
						<div className="practice-item-v2">
							<a href="/demo-03/practice-single-page">
								<div className="practice-circle"><i className="fas fa-fire"></i></div>
							</a>
					...
					<div className="col-lg-3 col-md-6">
						<div className="practice-item-v2">
							<a href="/demo-03/practice-single-page">
								<div className="practice-circle"><i className="fas fa-leaf"></i></div>
							</a>
					...
					<div className="col-lg-3 col-md-6">
						<div className="practice-item-v2">
							<a href="/demo-03/practice-single-page">
								<div className="practice-circle"><i className="fas fa-wheelchair"></i></div>
							</a>
		...
		<section className="section-holder">
			...
			<div className="col-lg-4 alignc">
				...
				<p className="icon-box-description"><a href="https://matchthemes.com/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="12717d7c6673716652776a737f627e773c717d7f">[email&#160;protected]</a></p>
			</div>
			</div>
