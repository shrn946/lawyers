...
export default function BlogListPage() {
  return (
    <>
      ...
      <PageBanner title="Blog List" subtitle="in business since 1970" />
			...
			<div className="container">
				<div className="row">
					<div className="col-lg-9  posts-holder post-sidebar ">
						<article className="blog-item blog-item-1col-list">
							<div className="post-image-list">
								<a href="/demo-03/blog-single-post">
									<div className="list-image" style={{ backgroundImage: `url('/demo-03/assets/images/blog/blog-1.jpg')` }}></div>
								</a>
							</div>
							<div className="post-holder ">
								<div className="list-holder">
									...
									<div className="article-excerpt"> Arnare varius mauris eu commodo. Aenean nibh risus, rhoncus eget consectetur ac. Consectetur adipiscing elit. Vivamus auctor condimentum sem et gravida. Maecenas id enim pharetra, sollicitudin dui eget, blandit lorem. Nunc vitae blandit lectus. Donec lacinia magna sit amet arcu...</div>
								</div>
							</div>
						</article>
						<article className="blog-item blog-item-1col-list">
							<div className="post-image-list">
								<a href="/demo-03/blog-single-post">
									<div className="list-image" style={{ backgroundImage: `url('/demo-03/assets/images/blog/blog-2.jpg')` }}></div>
								</a>
							</div>
							<div className="post-holder ">
								<div className="list-holder">
						...
						<article className="blog-item blog-item-1col-list">
							<div className="post-image-list">
								<a href="/demo-03/blog-single-post">
									<div className="list-image" style={{ backgroundImage: `url('/demo-03/assets/images/blog/blog-9.jpg')` }}></div>
								</a>
							</div>
							<div className="post-holder ">
								<div className="list-holder">
						...
						<article className="blog-item blog-item-1col-list">
							<div className="post-image-list">
								<a href="/demo-03/blog-single-post">
									<div className="list-image" style={{ backgroundImage: `url('/demo-03/assets/images/blog/blog-7.jpg')` }}></div>
								</a>
							</div>
							<div className="post-holder ">
								<div className="list-holder">
