...
export default function AttorneysPage() {
  return (
    <>
      ...
      <PageBanner title="Attorneys" subtitle="Meet our professional team" />
					...
					<div className="col-md-6 col-lg-4">
						<div className="lawyer-holder lawyer-3col">
							...
							<ul className="lawyer-social">
								...
								<li><a href="https://matchthemes.com/cdn-cgi/l/email-protection#04" target="_blank"><i className="far fa-envelope"></i></a></li>
							</ul>
						</div>
					</div>
					<div className="col-md-6 col-lg-4">
					...
					<div className="col-md-6 col-lg-4">
						<div className="lawyer-holder lawyer-3col">
							...
							<ul className="lawyer-social">
								<li><a href="#" target="_blank"><i className="fab fa-twitter"></i></a></li>
								<li><a href="#" target="_blank"><i className="fab fa-facebook-f"></i></a></li>
								<li><a href="https://matchthemes.com/cdn-cgi/l/email-protection#c1" target="_blank"><i className="far fa-envelope"></i></a></li>
							</ul>
						</div>
					</div>
					<div className="col-md-6 col-lg-4">
