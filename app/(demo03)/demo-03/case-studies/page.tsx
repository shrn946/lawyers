...
export default function CaseStudiesPage() {
  return (
    <>
      ...
      <PageBanner title="Case Studies" subtitle="in business since 1970" />
		...
		<section className="section-holder margin-b32">
			<div className="container">
				...
				<div className="case-studies-holder case-studies-short layout-masonry ">
					...
					<div className="case-study case-4col blog-item-masonry injuries health-care ">
						<div className="case-img-holder">
							<a href="/demo-03/cases-single-page">
					...
					<div className="case-study case-4col blog-item-masonry health-care">
						<div className="case-img-holder">
							<a href="/demo-03/cases-single-page">
