...
export default function TopHeader3Page() {
  return (
    <>
					...
					<div className="col-lg-4 col-md-6">
						<div className="lawyer-holder lawyer-3col">
							...
							<ul className="lawyer-social">
								...
								<li><a href="https://matchthemes.com/cdn-cgi/l/email-protection#da" target="_blank"><i className="far fa-envelope"></i></a></li>
							</ul>
						</div>
					</div>
					<div className="col-lg-4 col-md-6">
					...
					<div className="col-lg-4 col-md-6">
						<div className="lawyer-holder lawyer-3col">
							...
							<ul className="lawyer-social">
								<li><a href="#" target="_blank"><i className="fab fa-twitter"></i></a></li>
								<li><a href="#" target="_blank"><i className="fab fa-facebook-f"></i></a></li>
								<li><a href="https://matchthemes.com/cdn-cgi/l/email-protection#68" target="_blank"><i className="far fa-envelope"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div className="col-lg-6 margin-bm54">
						...
						<div className="icon-box-wrapper">
							...
							<div className="icon-box-content">
								...
								<p className="icon-box-description"><a href="https://matchthemes.com/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="7d1e1213091c1e093d18051c100d1118531e1210">[email&#160;protected]</a></p>
							</div>
						</div>
