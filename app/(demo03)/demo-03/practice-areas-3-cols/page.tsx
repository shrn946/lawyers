...
export default function PracticeAreas3ColsPage() {
  return (
    <>
      <LawyersHeader headerType="header-1" />
      <PageBanner title="Practice Areas 3 Cols" subtitle="in business since 1970" />
			...
			<div className="container">
				<div className="row practice-items-holder">
					...
					<div className="col-md-6 col-lg-4 practice-item-4cols">
						<a href="/demo-03/practice-single-page">
							<div className="practice-item">
								<div className="practice-icon"><i className="fas fa-plane"></i></div>
					...
					<div className="col-md-6 col-lg-4 practice-item-4cols">
						<a href="/demo-03/practice-single-page">
							<div className="practice-item">
								<div className="practice-icon"><i className="fas fa-fire"></i></div>
								<h3 className="practice-title">Burn Injuries</h3>
							</div>
						</a>
					</div>
					<div className="col-md-6 col-lg-4 practice-item-4cols">
						<a href="/demo-03/practice-single-page">
							<div className="practice-item">
								<div className="practice-icon"><i className="fas fa-leaf"></i></div>
								<h3 className="practice-title">Environmental Law</h3>
							</div>
						</a>
					</div>
					<div className="col-md-6 col-lg-4 practice-item-4cols">
						<a href="/demo-03/practice-single-page">
							<div className="practice-item">
								<div className="practice-icon"><i className="fas fa-wheelchair"></i></div>
								<h3 className="practice-title">Medical Abuse</h3>
							</div>
						</a>
					</div>
				</div>
