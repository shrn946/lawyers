...
export default function CaseStudies2ColsPage() {
  return (
    <>
      <LawyersHeader headerType="header-1" />
      <PageBanner title="Case Studies 2 Cols" subtitle="in business since 1970" />
		...
		<section className="section-holder margin-b32">
			<div className="container">
				...
				<div className="case-studies-holder case-studies-short layout-masonry ">
					<div className="case-study case-2col blog-item-masonry finance ">
					...
					<div className="case-study case-2col blog-item-masonry health-care  injuries ">
						<div className="case-img-holder">
							<a href="/demo-03/cases-single-page">
					...
					<div className="case-study case-2col blog-item-masonry injuries ">
						<div className="case-img-holder">
							<a href="/demo-03/cases-single-page">
					...
					<div className="case-study case-2col blog-item-masonry injuries health-care ">
						<div className="case-img-holder">
							<a href="/demo-03/cases-single-page">
					...
					<div className="case-study case-2col blog-item-masonry health-care">
						<div className="case-img-holder">
							<a href="/demo-03/cases-single-page">
