...
export default function PracticeImage3ColsPage() {
  return (
    <>
      <LawyersHeader headerType="header-1" />
      <PageBanner title="Practice Image 3 Cols" subtitle="in business since 1970" />
		...
		<section className="section-holder">
			<div className="container">
				...
				<div className="col-lg-4 col-md-6">
					<div className="practice-item-v2">
						<a href="/demo-03/practice-single-page">
							<div className="post-image"><img src="/demo-03/assets/images/practice/practice-2.jpg" className="img-fluid" alt="" style={{ maxWidth: '100%' }} /></div>
						</a>
						<h5 className="practice-title-v2"><a href="/demo-03/practice-single-page">Burn Injuries</a></h5>
						<div className="practice-excerpt">Fusce commodo iaculis pulvinar. Cras faucibus facilisis aliquet. Morbi lorem nulla, bibendum vel bibendum id, aliquet ut ipsum. Praesent est diam, porta.</div>
						<a className="read-more" href="/demo-03/practice-single-page">Learn More</a>
					</div>
				</div>
				<div className="col-lg-4 col-md-6">
					<div className="practice-item-v2">
						<a href="/demo-03/practice-single-page">
							<div className="post-image"><img src="/demo-03/assets/images/practice/practice-11.jpg" className="img-fluid" alt="" style={{ maxWidth: '100%' }} /></div>
						</a>
						<h5 className="practice-title-v2"><a href="/demo-03/practice-single-page">Environmental Law</a></h5>
						<div className="practice-excerpt">Fusce commodo iaculis pulvinar. Cras faucibus facilisis aliquet. Morbi lorem nulla, bibendum vel bibendum id, aliquet ut ipsum. Praesent est diam, porta.</div>
						<a className="read-more" href="/demo-03/practice-single-page">Learn More</a>
					</div>
				</div>
				<div className="col-lg-4 col-md-6">
					<div className="practice-item-v2">
						<a href="/demo-03/practice-single-page">
							<div className="post-image"><img src="/demo-03/assets/images/practice/practice-3.jpg" className="img-fluid" alt="" style={{ maxWidth: '100%' }} /></div>
						</a>
						<h5 className="practice-title-v2"><a href="/demo-03/practice-single-page">Medical Abuse</a></h5>
						<div className="practice-excerpt">Fusce commodo iaculis pulvinar. Cras faucibus facilisis aliquet. Morbi lorem nulla, bibendum vel bibendum id, aliquet ut ipsum. Praesent est diam, porta.</div>
						<a className="read-more" href="/demo-03/practice-single-page">Learn More</a>
					</div>
				</div>
		...
		<section className="section-holder">
			...
			<div className="col-lg-4 alignc">
				...
				<p className="icon-box-description"><a href="https://matchthemes.com/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="beddd1d0cadfddcafedbc6dfd3ced2db90ddd1d3">[email&#160;protected]</a></p>
			</div>
			</div>
